<%@page
	import="com.chelseaUniversity.ver1.repository.InformationRepositoryImpl"%>
...
<div class="d-flex justify-content-center align-items-start"
	...
	<main style="width: 100%; padding: 20px;">
		...
		<div class="sub--filter">
			<form action="${pageContext.request.contextPath}/sugang/subjectList"
				method="get">
				<div>
	...
	<h4 class="mt-4">
				...
				<c:forEach var="subject" items="${subjectList}">
					<tr>
						...
						<td><a
												...
												onclick="window.open(this.href, '_blank', 'width=720, height=1000'); return false;">강의계획서</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
		...
		<ul class="page--list">
			...
			%>
			<li><a
									href="${pageContext.request.contextPath}/sugang/subjectList?page=<%= i %>"
									class="active"><%=i%></a></li>
			<%
			} else {
			%>
			<li><a
									href="${pageContext.request.contextPath}/sugang/subjectList?page=<%= i %>"><%=i%></a></li>
			<%
			}
			}
			%>
