...
<div class="d-flex justify-content-center align-items-start"
	...
	<div class="sub--menu">
		...
		<div class="sub--menu--mid">
			<table class="sub--menu--table" border="1">
				<tbody>
					<tr>
						<td><a href="/chelseaUniversity/user/studentList"
							class="selected--menu">학생 명단 조회</a></td>
					</tr>
					<tr>
						<td><a href="/chelseaUniversity/user/professorList">교수 명단
								조회</a></td>
					</tr>
					<tr>
	...
	<section>
		...
		<!-- 학생 학과 번호와 학번으로 검색 -->
		<div>
			<form action="${pageContext.request.contextPath}/user/studentList"
				method="get">
				<label for="dept_id">학과 번호</label> <input type="search" id="dept_id"
					name="dept_id"> <label for="stu_id">학번</label> <input
					type="search" id="stu_id" name="stu_id">
				<button type="submit">
					<div class="">
						<p>조회</p>
						<div>
				...
				<c:forEach begin="1" end="${totalPages}" var="i">
					<c:choose>
						<c:when test="${not empty deptId}">
							...
							<span class="current-page"><a
								href="${pageContext.request.contextPath}/user/studentList?page=${i}">${i}</a></span>
						</c:when>
						<c:when test="${not empty stuId}">
