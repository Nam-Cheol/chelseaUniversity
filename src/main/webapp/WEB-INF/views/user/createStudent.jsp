...
<div>
	<form action="${pageContext.request.contextPath}/user/student" method="post">
		...
		<input type="name" id="name" name="name" placeholder="학생 이름을 입력하세요." required>
		...
		<input type="text" id="dept-id" name="deptId" placeholder="학과ID를 입력하세요." required>
		
		<label for="entr">입학일</label>
		<input type="date" id="entr" name="entranceDate" placeholder="이메일을 입력하세요." required>
